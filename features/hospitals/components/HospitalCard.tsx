  ...
  return (
    <Link href={`/hospitals/${hospital.id}`}>
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm hover:border-blue-300 hover:shadow-md transition-all h-full">
        ...
        <p className="mt-1 text-sm text-slate-500">{hospital.city}, {hospital.state}</p>
        <p className="mt-0.5 text-xs text-slate-400 truncate">{hospital.address}</p>
